...
function ucapan() {
  ...
  let res = "Gatidur Lu? Gw aja ngantuk😬"
  if (time >= 4) {
    res = "Pagi Sekolah Anj Jangan main Bot 🌄"
  }
  if (time >= 10) {
    res = "Siang Tidur Cokkk Gw Ngantuk ☀️"
  }
  if (time >= 15) {
    res = "Sore2 Traktir Boba Kek Malah Main Bot 🌇"
  }
  if (time >= 18) {
    res = "Malam Nih Tidur Lu Jan Main Bot 🌃"
  }
  return res
}
function timeimg() {
